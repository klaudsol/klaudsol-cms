...
export const SET_CURRENT_ENTITY_TYPE = "SET_CURRENT_ENTITY_TYPE";
export const SET_FORCE_CHANGE_PASSWORD= "SET_FORCE_CHANGE_PASSWORD";
export const SET_ERROR =  'SET_ERROR';
export const SET_ALL_VALIDATES = 'SET_ALL_VALIDATES';
export const SET_ADD_CONTENT_TYPE_MODAL = 'SET_ADD_CONTENT_TYPE_MODAL';
export const SET_HEADER_DROPDOWN = 'SET_ADD_HEADER_DROPDOWN';
