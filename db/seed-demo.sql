...
INSERT INTO `attributes` VALUES (1,'title','text',1,1),(2,'body','textarea',2,1),(3,'food_name','text',1,2),(4,'price','float',2,2),(5,'description','textarea',3,2),(6,'name','text',1,3),(7,'image','image',2,3),(8,'link','link',3,3),(9,'title','text',1,9),(10,'lyrics','text',2,9),(11,'name','text',1,10),(12,'address','text',2,10),(13,'price','text',3,10),(14,'lot_area','text',4,10),(15,'description','textarea',5,10),(16,'images','image',6,10),(17,'latitude','float',7,10),(18,'longhitude','float',8,10),(19,'name','text',1,11),(20,'name','text',1,12),(21,'property_features','text',9,10);
...
INSERT INTO `entities` VALUES (1,'how-to-run-shopify-cli-in-aws-cloud-9',1),(2,'how-to-deploy-your-shopify-cli-app-on-aws-ec2-using-docker',1),(3,'porchetta',2),(89,'donut',2),(92,'milktea',2),(94,'bacon',2),(96,'cassava-cake',2),(102,'chocolate-cake',2),(105,'chicken-noodle-soup',2),(106,'aws',3),(107,'react',3),(108,'react-native',3),(109,'nextjs',3),(110,'nodejs',3),(111,'strapi',3),(112,'aws-amplify',3),(113,'aws-aurora-serverless',3),(114,'aws-elastic-beanstalk',3),(132,'its-late-in-the-evening',9),(133,'bgc',12),(134,'aurelia-residences',10);
...
INSERT INTO `entity_types` VALUES (1,'Articles','articles'),(2,'Menu','menus'),(3,'Technologies','tech');
...
INSERT INTO `people` VALUES (1,'John','Doe','Administrator',1,'admin@klaudsol.com','1686254050d3f34b4efe72a4ce628e3e123d6699901283e2f3cdc1bdae83e508','5a3KTYp6Xg','2022-09-25 02:39:02');
...
/*!40000 ALTER TABLE `values` DISABLE KEYS */;
INSERT INTO `groups` VALUES (1,"Super Administrators","Lorem ipsum",1),(2,"Administrators","Lorem ipsum",1),(3,"Editors","Lorem ipsum",1),(4,"Guests","Lorem ipsum",1);
/*!40000 ALTER TABLE `values` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `values` DISABLE KEYS */;
INSERT INTO `group_capabilities` VALUES (1,1,NULL,NULL,NULL),VALUES (1,2,NULL,NULL,NULL),VALUES (1,3,NULL,NULL,NULL),VALUES (1,4,NULL,NULL,NULL),VALUES (1,5,NULL,NULL,NULL),VALUES (1,6,NULL,NULL,NULL),VALUES (1,7,NULL,NULL,NULL),VALUES (1,8,NULL,NULL,NULL),VALUES (1,9,NULL,NULL,NULL),VALUES (1,10,NULL,NULL,NULL),VALUES (1,11,NULL,NULL,NULL),VALUES (2,1,NULL,NULL,NULL),VALUES (2,2,NULL,NULL,NULL),VALUES (2,3,NULL,NULL,NULL),VALUES (2,4,NULL,NULL,NULL),VALUES (2,5,NULL,NULL,NULL),VALUES (2,6,NULL,NULL,NULL),VALUES (2,7,NULL,NULL,NULL),VALUES (2,8,NULL,NULL,NULL),VALUES (2,9,NULL,NULL,NULL),VALUES (2,10,NULL,NULL,NULL),VALUES (2,11,NULL,NULL,NULL),VALUES (3,1,NULL,NULL,NULL),VALUES (3,2,NULL,NULL,NULL),VALUES (3,3,NULL,NULL,NULL),VALUES (3,4,NULL,NULL,NULL),VALUES (4,1,NULL,NULL,NULL),VALUES (4,3);
