...
const nextConfig = {
  ...
  env: {
    ...
    S3_AWS_ACCESS_KEY_ID_CERTIFICATE: process.env.S3_AWS_ACCESS_KEY_ID_CERTIFICATE,
    S3_AWS_SECRET_ACCESS_KEY_CERTIFICATE: process.env.S3_AWS_SECRET_ACCESS_KEY_CERTIFICATE,
