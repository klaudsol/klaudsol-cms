...
export default function Certificate({ cache }) {
  ...
  const handleDownloadPdf = async () => {
    ...
    const certificateID = "d569f634-49d6-460a-8917-0610c47bf716";
          ...
          <div className={styles["certificate-screen"]}>
            <div ref={printRef} className={styles["certificate"]}>
              <div className={styles["certificate-content"]}>
                <div className={styles["certificate-info"]}>
                  ...
                  <div className={styles["container"]}>
                    <h1>CERTIFICATE OF INTERNSHIP RENDERED HOURS</h1>

                    <p>This is to certify that</p>
                    <h2 className={styles["recipient"]}>
                    JULIANNE ROSE VINZON
                    </h2>

                    <p className={styles["para"]}>
                    Has rendered hours during her period of internship 
                    from <b>March 16 to May 05, 2022</b>, 
                    after having rendered <b>233.00 hours</b> with KlaudSol.
                    </p>

                    <p className={styles["para"]}>
                    During her course of internship with KlaudSol, 
                    she worked on the KlaudSol SME project. 
                    She has put her best effort into the project, 
                    and her performance was at par with our expectations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles["uuid"]}>
                <p>certificate id: d569f634-49d6-460a-8917-0610c47bf716</p>
              </div>
            </div>
            <br />
          </div>
