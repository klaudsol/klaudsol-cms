...
export default function CertificateGenerator({ cache }) {
  ...
  const addTemplateDB = useCallback(
    (logo, certbg, formValues, certificateContent, color1, color2) => {
      ...
      (async () => {
        try {
          ...
          var logo_location =
            "https://sme-certificate-media.s3.amazonaws.com/61e23c1956904573da70f92db7e18b3d.png";
          var bg_location =
            "https://sme-certificate-media.s3.amazonaws.com/5f664db602f3b462942d824e30db6a01.png";
        ...
        >
          ...
          >
            <div className={styles["header-container"]}>
              ...
              >
                <Image src={imgData} alt="" layout="fill" objectFit="contain" />
              </div>
    ...
    return (
      <>
        ...
        <div className="cert-submit-ctnr">
          <button
            className="cert-add-btn cert-submit-btn"
